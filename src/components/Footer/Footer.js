...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <Link to="/topics" className="flex items-center">
                <img src="favicon.ico" className="mr-3 h-24 rounded-lg" alt="FlowBite Logo"></img>
                <span className="self-center text-2xl  whitespace-nowrap text-indigo-500 font-black dark:text-white">Quiz Bomber</span>
            </Link>
        </div>
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ">
            <div>
                <h2 className="mb-6 text-sm font-semibold uppercase dark:text-white  text-indigo-500">Resources</h2>
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4 text-indigo-500">
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold text-indigo-500 uppercase dark:text-white">Follow us</h2>
            ...
            <div>
                <h2 className="mb-6 text-sm font-semibold text-indigo-500 uppercase dark:text-white">Legal</h2>
                <ul className=" text-indigo-600 dark:text-gray-400">
                    <li className="mb-4">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm  text-indigo-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Quiz-Bomber™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <Link href="#" className="text-gray-500 hover:text-indigo-500 dark:hover:text-white">
            ...
            <Link href="#" className="text-gray-500 hover: hover:text-indigo-500 dark:hover:text-white">
